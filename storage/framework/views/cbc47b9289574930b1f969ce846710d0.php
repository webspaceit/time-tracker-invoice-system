...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?php echo e(route('invoices.index')); ?>" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Back</a>
</div>
...
<div class="card shadow-sm mb-4" style="border:1px solid #dee2e6;">
    <div class="card-body p-4">
        <form method="POST" action="<?php echo e(route('invoices.store')); ?>" id="invoiceForm">
            <?php echo csrf_field(); ?>
            <?php $invoice = new \App\Models\Invoice(['currency' => old('currency', 'USD')]); ?>
...
<script>
let itemCount = <?php echo e(max(1, count(old('items', [['description' => 'Total Hours']])))); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\wamp64\www\invoice-system-server\resources\views/invoices/create.blade.php ENDPATH**/ ?>