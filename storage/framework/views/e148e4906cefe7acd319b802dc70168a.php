    ...
    <div class="px-2">
        ...
        <div id="timer-start-form" class="mt-2 d-none">
            <select id="timer-project-select" class="form-select form-select-sm mb-1" onchange="timerProjectChanged(this)">
                ...
                <?php $__currentLoopData = \App\Models\Project::with('customer')->where('is_active', true)->orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="mt-1 d-flex justify-content-between">
                <a href="<?php echo e(route('customers.create')); ?>" class="text-white-50" style="font-size:0.65rem" target="_blank">
                    + New customer
                </a>
                <a href="<?php echo e(route('projects.index')); ?>" class="text-white-50" style="font-size:0.65rem">
                    + Manage projects
                </a>
            </div>
        </div>
        ...
        <div id="timer-manual-form" class="mt-2 d-none">
            ...
            <div class="row g-1 mb-1">
                <div class="col-6">
                    <input type="date" id="manual-date" class="form-control form-control-sm" value="<?php echo e(date('Y-m-d')); ?>">
                </div>
                <div class="col-6">
        ...
        <div class="mt-1 text-center">
            <a href="<?php echo e(route('time-tracker.index')); ?>" class="text-white-50 small" style="font-size:0.7rem">
...
function refreshTimerState() {
    fetch('<?php echo e(route("time-tracker.current")); ?>')
        .then(r => r.json())
        .then(data => {
            if (data.running) {
...
function refreshTodayEntries() {
    fetch('<?php echo e(route("time-tracker.today")); ?>')
        .then(r => r.json())
        .then(data => {
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH E:\wamp64\www\invoice-system-server\resources\views/time-tracker/partials/_sidebar.blade.php ENDPATH**/ ?>