            ...
            <div class="col-md-3 col-lg-2 px-0 sidebar">
                <div class="py-4 px-3 sidebar-inner d-flex flex-column">
                    ...
                    <nav class="nav flex-column sidebar-nav">
                        ...
                        <a class="nav-link <?php echo e(request()->routeIs('time-tracker.*') ? 'active' : ''); ?>" href="<?php echo e(route('time-tracker.index')); ?>">
                            <i class="fas fa-stopwatch me-2"></i> Time Tracker
                        </a>
                    </nav>
                    <?php if(auth()->guard()->check()): ?>
                    <div class="sidebar-tracker">
                        <?php echo $__env->make('time-tracker.partials._sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
...
</html><?php /**PATH E:\wamp64\www\invoice-system-server\resources\views/layouts/app.blade.php ENDPATH**/ ?>