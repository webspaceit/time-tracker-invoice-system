...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="fw-bold" style="color:var(--brand);"><i class="fas fa-edit me-2"></i>Edit Invoice {{ $invoice->invoice_number }}</h4>
    <div>
        <a href="{{ route('invoices.pdf', $invoice) }}" class="btn btn-outline-danger"><i class="fas fa-file-pdf"></i> PDF</a>
        <a href="{{ route('invoices.show', $invoice) }}" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Back</a>
    </div>
</div>
