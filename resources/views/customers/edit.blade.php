...
<div class="card shadow-sm" style="border:1px solid #dee2e6;">
    <div class="card-header brand-header"><h5 class="mb-0"><i class="fas fa-user-edit me-2"></i>Edit Customer</h5></div>
    <div class="card-body">
        <form method="POST" action="{{ route('customers.update', $customer) }}">
            ...
            <div class="mb-3">
                ...
                <select name="currency" class="form-control @error('currency') is-invalid @enderror" required>
                    @foreach(\App\Helpers\Currency::OPTIONS as $code)
                        <option value="{{ $code }}" @selected(old('currency', $customer->currency ?? 'USD') === $code)>
            ...
            <button type="submit" class="btn btn-brand"><i class="fas fa-save me-1"></i>Update</button>
