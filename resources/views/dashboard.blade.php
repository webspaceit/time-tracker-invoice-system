...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('settings.profile') }}" class="row g-3">
                @csrf
                <div class="col-md-4">
            ...
            <hr>
            <form method="POST" action="{{ route('settings.timezone') }}" class="row g-3 align-items-center">
                @csrf
                <div class="col-auto">
                ...
                <div class="col-auto">
                    <small class="text-muted">Current time: {{ in_user_timezone(now())->format('Y-m-d H:i:s T') }}</small>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold">{{ format_money($totalRevenue) }}</h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h2 class="mb-0 fw-bold">{{ format_money($pendingAmount) }}</h2>
                        </div>
    ...
    <div class="row mb-4">
        <div class="col-md-6 mb-3">
            <div class="card">
                <div class="card-header brand-header">
                    <h5 class="mb-0"><i class="fas fa-chart-line me-2"></i>Monthly Revenue {{ date('Y') }}</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6 mb-3">
            <div class="card">
                <div class="card-header brand-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('invoices.index') }}" class="btn btn-sm btn-light" style="color:var(--brand);">View All</a>
                </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ format_money($invoice->total_amount, $invoice->currency) }}</td>
                                    <td class="text-danger">{{ now()->diffInDays($invoice->due_date) }} days</td>
                                    <td>
